        ...
        <div className="navbar bg-base-100">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content  font-medium mt-3 z-[1] p-2 shadow bg-base-100 dark:text-white rounded-box w-52">
                        {navItems}
                    </ul>
                </div>
                <a className="btn btn-ghost normal-case text-xl">Planet News</a>
            </div>
